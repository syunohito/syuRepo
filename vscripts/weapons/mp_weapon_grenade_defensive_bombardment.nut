...
const float DEFENSIVE_BOMBARDMENT_RADIUS 		 	= 1 //The radius of the bombardment area.
const int	DEFENSIVE_BOMBARDMENT_DENSITY			= 1	//The density of the distributed shell randomness.
const float DEFENSIVE_BOMBARDMENT_DURATION			= 30.0 //The duration the bombardment will last.
const float DEFENSIVE_BOMBARDMENT_DELAY 			= 0.01 //The bombardment will wait 2.0 seconds before firing the first shell.
