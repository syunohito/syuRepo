...
#if SERVER
const int TRAIN_ACCELERATION = 800;	
const int TRAIN_INIT_SPEED = 7000;	// Has to be the same or we could get an offset because of the junction thread delay
const int TRAIN_MAX_SPEED = 70000;
const int TRAIN_CAR_OFFSET = 15000;	// Original seems to be 840, +10 to fix clipping on angles
